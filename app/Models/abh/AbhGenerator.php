...
class AbhGenerator extends Model
{
    ...
    {
        return $this->hasOne(AbhGeneratorStatus::class,'abh_generator_id','id');
    }

    public function latest_agency_affiliated(): HasMany
    {
        return $this->hasMany(AbhGeneratorAffiliation::class,'abh_generator_id','id')->latest();
    }
}
