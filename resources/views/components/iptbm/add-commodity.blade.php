<div class="modal fade" id="addCom" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <form method="post" action="{{route('technology.store.commodity')}}">
                ...
                <div class="modal-body">
                    <div class="card-title">
                        <small>This will be added to the pre-listed commodities</small>
                    </div>
                    <div class="form-group fw-bold">
                        <div class="form-floating mb-3">
                            <input type="hidden" name="indus_name" value="{{$industry_id}}">
                            <input type="text" class="form-control" id="floatingInput"
                                   placeholder="sample" name="name_com" value="{{old("name_com")}}">
