                ...
                <ul class="flex flex-col md:p-0  font-medium w-full ps-4  md:py-2  bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-gray-600 dark:bg-gray-700 md:dark:bg-gray-900 dark:border-gray-700">
                    <li>
                        <a href="{{route("iptbm.admin.ipalerts")}}"
                           class="block  py-2 pl-3 pr-4 text-gray-900 rounded dark:bg-transparent bg-transparent  @if($route==='iptbm.admin.ipalerts') px-2 bg-gray-300 dark:bg-blue-500 hover:text-blue-700 @endif   md:p-0  dark:text-gray-50   dark:border-gray-700">
                            Patent
                        </a>
                    </li>
                    <li>
