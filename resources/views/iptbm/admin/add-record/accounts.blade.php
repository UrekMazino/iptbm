...
@section('sub-content')
    <div class="container-fluid">
        <div class="relative overflow-x-auto my-4">
            <table class="w-100 text-sm border border-gray-500  rounded text-left text-gray-500 dark:text-gray-400"  id="accountTable">
                    ...
                    <tr>
                        ...
                        <td class="py-2 px-2">
                            <a href="{{route("iptbm.admin.addrecord.editaccount",['id'=>$user->id])}}">
                                <svg class="w-5 h-5 text-blue-600 dark:text-blue-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
