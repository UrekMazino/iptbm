...
@section('sub-content')
    <div class="container-fluid  p-0">
        ...
        <div class="sm:hidden">
            ...
            <select id="tabs"
                ...
                @foreach($industries as $key=>$industry)
                    <option>{{ Str::title(Str::lower(Str::limit($industry->name, 20, '...'))) }}</option>
                @endforeach
        ...
        <div class="my-3 mt-5">
            <h5 class="text-3xl font-medium mx-4 text-gray-600 dark:text-gray-400">Commodities</h5>
        </div>
        <div id="accordion-collapse" class="mx-4" data-accordion="open">
            @foreach($industries as $key=>$industry)
                <h2 id="nav{{$industry->id}}">
                    <button type="button"
                            class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border-l border-r border-t border-b border-b-0 border-gray-200 @if($key==0) rounded-t-xl @endif focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800"
                ...
                <div id="accordion-collapse-body-{{$industry->id}}" class="hidden"
                    ...
                    <div
                        ...
                        <table
                            ...
                            <tbody>
                            @foreach($industry->commodities as $keyA=>$commodity)
                                <tr class="hover:bg-gray-300 dark:hover:bg-gray-900 transition duration-300">
                                    <td id="#navCom{{$commodity->id}}" class="px-6 py-2 ">
