    ...
    <div class="w-full">
        ...
        <div class="px-4 mt-10">
            ...
            <div class="relative overflow-x-auto  shadow-lg w-full p-4 bg-white dark:bg-gray-800 mt-2 rounded-lg text-gray-600 dark:text-white">
                <table id="techAdopter" class="w-full display cell-border stripe table-auto md:table-fixed hover text-sm  rounded text-left text-gray-500  border-gray-300 dark:border-gray-600  dark:text-gray-400">
                    <thead class="text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        <th scope="col" class="px-6 py-3 break-words border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            Technology
                        </th>
                        ...
                        <th scope="col" class="compDes px-6 py-3 border break-words border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            Company Description
                        </th>
                        <th scope="col" class="businessStruc px-6 py-3 border break-words border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            Business Structure
                        </th>
                        <th scope="col" class="businessReg px-6 py-3 border break-words border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        ...
                        <th scope="col" class="incubation px-6 py-3 border break-words border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            For Incubation?
                        </th>
                        <th scope="col" class="contact px-6 py-3 border break-words border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            Contact Details
                        </th>
                        <th scope="col" class="px-6 action py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        Action
                        </th>
                    </tr>
                    <tr class="border-0 filters">
                        ...
                        <th scope="col" class="fil contact px-6 py-3 border break-words border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            Contact Details
                        </th>
                        <th scope="col" class="px-6 action py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    ...
                    @foreach($technologies as $tech)
                        <tr>
                            <td  class="p-2 break-words">
                                <a href="{{route("iptbm.staff.technology.show",['id'=>$tech->technology->id])}}" class="text-blue-400 text-decoration-none">
                            ...
                            <td class="break-words">
                                <div class="flex justify-start items-center gap-4">
                                    <x-link-button  :url="route('iptbm.staff.commercialization.adoptedTech',['id'=>$tech->id])">
                                        <span class="fa-solid fa-edit w-4 h-4"></span>
                                    </x-link-button>

                                    <livewire:iptbm.staff.adopter.delete-adopter wire:key="{{$tech->id}}" :adopter="$tech" />
                                </div>
