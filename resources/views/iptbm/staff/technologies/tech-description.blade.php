...
@section('content')
    <div class="w-full">
                    ...
                    <nav class="flex" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            <li class="inline-flex items-center">
                                <a href="{{route("iptbm.staff.technology")}}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="{{route("iptbm.staff.technology.show",["id"=>$technology_description->technology_profile->id])}}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">Technology Details</a>
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="" class="ml-1 text-sm font-medium  hover:text-blue-600 md:ml-2 text-blue-700 ">Full Technology Description</a>
        ...
        <livewire:iptbm.staff.technology.fulltechdescription.description :technology_description="$technology_description"/>
    </div>
