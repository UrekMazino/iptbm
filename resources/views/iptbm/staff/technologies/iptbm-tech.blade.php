        ...
        <div class="px-4 w-full mt-10">
            ...
            <x-card>
                <div class="relative p-2 overflow-x-auto w-full ">
                    <table id="allTech" class="w-full table-fixed text-sm cell-border stripe hover rounded text-left text-gray-500  border-gray-300 dark:border-gray-600  dark:text-gray-400">
                        ...
                        <tr >
                            ...
                            <th scope="col" class="action w-fit py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        ...
                        @foreach($profile as $val)
                            ...
                            @foreach($val->technologies as $techVal)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <x-link-button :url="route('iptbm.staff.tech.public-view',['id'=>$techVal->id])">
