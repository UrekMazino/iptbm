...
@section('content')
    <div class="tab-pane fade show active"
        ...
        <div class="container-fluid mt-2">
            ...
            Modal for industry
            --->
            <div class="modal fade" id="indusAdd" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="indusLab" aria-hidden="true">
                        ...
                        <form method="post" action="{{route("technology.store.industry")}}">
                            ...
                            <div class="modal-body">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" placeholder="sample" name="name_indus" value="{{old("name_indus")}}">
          ...
          Modal for category
          --->
            <div class="modal fade" id="techCatmod" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="indusLab" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <form method="post" action="{{route("technology.store.category")}}">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" placeholder="sample" name="name_cat" value="{{old("name_cat")}}">
            ...
            <!--
             ...
             --->
            <div class="modal fade" id="techCommod" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="indusLab" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <form method="post" action="{{route("technology.store.commodity")}}">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput" placeholder="sample" name="name_com" value="{{old("name_com")}}">
            ...
            <form method="post" action="{{route("iptbm.technology.store")}}" class="needs-validation">
                ...
                <div class="form-group">
                    ...
                    <textarea rows="10" class="form-control @error("title") is-invalid @enderror" name="title" id="title" rows="3">{{old('title')}}</textarea>
                    @error('title')
                ...
                <div class="form-group mt-3">
                    ...
                    <select class="form-control @error("industry")is-invalid @enderror"  name="industry" id="industry" value="{{old("industry")}}">
                ...
                <div class="form-group mt-3" >
                    ...
                    <select class="form-control @error("techCat") is-invalid @enderror"  name="techCat" id="techCat" value="{{old("techCat")}}">
                    ...
                    @endif
                    <div class="col-md-auto mt-2">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#techCatmod">
                            <span class="fa-solid fa-plus-square me-2" aria-hidden="true"></span>Add new Technology Category
                        </button>
                    </div>
                </div>
                <div class="form-group mt-3" >
                    ...
                    <select class="form-control @error("techCom") is-invalid @enderror" name="techCom" id="como" value="{{old("techCom")}}">
                        <option value="" selected disabled>Select</option>
                    </select>
                    @error('techCom')
                    <div class="form-text text-danger">
                    ...
                    @endif
                    <div class="col-md-auto mt-2">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#techCommod">
                            <span class="fa-solid fa-plus-square me-2" aria-hidden="true"></span>Add new Technology Commodity
                        </button>
                    </div>
                </div>
                <div class="form-group mt-3">
