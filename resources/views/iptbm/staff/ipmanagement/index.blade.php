        ...
        <nav
            ...
            <nav class="bg-white border-gray-200 dark:bg-gray-900">
                <div class="flex justify-between items-center">
                    <div class="me-4 p-4">
                        <button data-modal-target="addIpman" data-modal-toggle="addIpman"
                ...
                <div class="relative overflow-x-auto  p-2 w-full ">
                    <table id="iptbmIpAlertTable"
                        ...
                        <tr class="border-0 ">
                            ...
                            <th scope="col"
                                class="py-3 agent border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                Agent Name
                            </th>
                            <th scope="col"
                                class="py-3 ipstatus border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">

                                Protection Status
                            </th>
                            <th scope="col"
                                class="py-3 abstract border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            ...
                            <th scope="col"
                                class="py-3 totalcost border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                Total Cost
                            </th>
                        ...
                        <tr class="border-0 filters">
                            ...
                            <th scope="col"
                                class="fil py-3 agent border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">

                            </th>
                            <th scope="col"
                                class="fil py-3 ipstatus border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">


                            </th>
                            <th scope="col"
                                class="fil py-3 abstract border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            ...
                            <th scope="col"
                                class="fil  task py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">

                            </th>


                            <th scope="col"
                                class="fil py-3 totalcost border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <livewire:iptbm.staff.ip-management.task-collection
                                                wire:key="taskcollection-{{$val->id}}" :alert="$val"/>
                                        </td>
                                        <td>
                                            <x-input-label>
