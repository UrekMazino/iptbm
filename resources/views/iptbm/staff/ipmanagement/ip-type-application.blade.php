                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="{{route("iptbm.staff.ip-management.application.index",['id'=>$ip_alert->id])}}" class="ml-1 text-sm font-medium  hover:text-blue-600 md:ml-2 text-blue-700 ">Ip Application</a>
                            ...
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <a href="{{route("iptbm.staff.ip-alert.task",['id'=>$ip_alert->id])}}" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Ip Task</a>
