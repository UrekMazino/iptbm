<x-grid col="3" gap="4">
    <div>
        <x-card class=" aspect-square relative group overflow-hidden ">
            ...
            <x-pop-modal name="profPhoto" class="max-w-xl" modal-title="Update Profile Photo" static="true"
                         close-action="reseter">
                <form class="space-y-4" wire:submit.prevent="savePhoto">
                    <div class="flex items-center justify-center w-3/4 mx-auto ">
                        ...
                        >
                            ...
                            <input wire:model="photo" id="dropzone-file" type="file" accept="image/png,image/jpeg"
                                   class="hidden"/>
                    ...
                    <div>
                        ...
                        <x-secondary-button type="submit" wire:loading.attr="disabled" wire:target="savePhoto"
    ...
    <x-card class="md:col-span-2 flex justify-center items-center relative group overflow-hidden">
        <x-pop-modal close-action="resetTagline" name="updateTagLine" modal-title="Update Profile Tag line"
            ...
            <form class="space-y-4" wire:submit.prevent="saveTagline">
                ...
                <x-secondary-button type="submit" wire:loading.attr="disabled" wire:target="saveTagline"
                                    class="py-2 w-full overflow-hidden">
