        ...
        <x-card-panel class="relative overflow-x-auto w-full">
            <table id="precomTab"
                ...
                <tr>
                    ...
                    <th scope="col"
                        class=" region px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        Region
                    </th>
                    <th scope="col"
                    ...
                    <th scope="col"
                        class="action w-44 px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        Action
                    </th>
                </tr>
                ...
                @foreach($precom_tech as $precom)
                    <tr>
                        ...
                        <td>
                            {{$precom->technology->iptbmprofiles->agency->region->name}}
                        </td>
                        <td>
                        ...
                        <td>
                            {{$precom->created_at->format('F-d-Y')}}
                        </td>
                        <td>
                            {{$precom->updated_at->format('F-d-Y')}}
                        </td>
                        <td>
                            <x-link-button :url="route('abh.admin.commercialization.precom-details.admin',['precom'=>$precom->id])">
                                Details
                            </x-link-button>
                        </td>
                    </tr>
...
@section('script')
    <script>
        ...
        $(function () {
            ...
            table.columns(['.id_db','.region','.owner','.new_tech_name','.cost','.roi','.com_mode','.dated_insert','.date_update']).visible(false, false);
