                ...
                @foreach($precom_tech as $precom)
                    <tr>
                        ...
                        <td>
                            ...
                            <x-pop-modal class="max-w-md" name="deletePrecom-{{$precom->id}}">
                                <div class="text-center">
                                    ...
                                    <div class="flex justify-center items-center space-x-4">
                                        ...
                                        <button type="submit" wire:click.prevent="deletePrecom({{$precom->id}})" class="py-2 px-3 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">
                                            Yes, I'm sure
                                        </button>
                                    </div>
                                </div>
                            </x-pop-modal>
                            <x-danger-button class="ms-2" data-modal-toggle="deletePrecom-{{$precom->id}}">
                                Delete
                            </x-danger-button>
                        </td>
                    </tr>
