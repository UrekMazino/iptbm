        ...
        <x-card-panel class="relative overflow-x-auto w-full">
            <table id="adopterTab"
                ...
                <tr>
                    ...
                    <th scope="col"
                        class="action px-6 w-44 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        Action
                    </th>
                </tr>
                            ...
                            <x-pop-modal class="max-w-md" name="deleteAdopter-{{$adopter->id}}">
                                <div class="text-center">
                                    ...
                                    <div class="flex justify-center items-center space-x-4">
                                        ...
                                        <button type="submit" wire:click.prevent="delete_adopter({{$adopter->id}})" class="py-2 px-3 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">
                                            Yes, I'm sure
                                        </button>
                                    </div>
                                </div>
                            </x-pop-modal>
                            <x-danger-button class="ms-2" data-modal-toggle="deleteAdopter-{{$adopter->id}}">
                                Delete
                            </x-danger-button>
                        </td>
                    </tr>
