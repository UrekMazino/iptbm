                                            ...
                                            <div>
                                                <x-pop-modal name="deleteContact-{{$val->id}}" class="max-w-md">
                                                    ...
                                                    <div class="flex justify-center items-center space-x-4">
                                                        ...
                                                        <button type="submit" wire:click.prevent="delete_contact({{$val->id}})" class="py-2 px-3 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">
                                                            Yes, I'm sure
                                                        </button>
                                                    </div>
                                                </x-pop-modal>
