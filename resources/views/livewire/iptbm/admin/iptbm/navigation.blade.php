<div
    class="sticky-top  z-30 w-auto h-16 bg-gray-50 border-t border-b py-2 my-4 border-gray-200 dark:bg-gray-700 dark:border-gray-600">
    ...
    <div class="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
        ...
        <a type="button" href="{{route("iptbm.admin.iptbm_profiles.profiles-details.technology",["id"=>$profile_id])}}"
            ...
            <span
                class="text-sm text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500">Technologies</span>
        </a>
        <button type="button"
                class="inline-flex @if($current==="sample2") bg-gray-800 @endif flex-col items-center transition duration-300 rounded-lg justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
            <svg
                class="w-6 h-6 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500"
                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path
            ...
            <span
                class="text-sm text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500 text-nowrap">Projects</span>
        </button>
        <button type="button"
                class="inline-flex @if($current==="sample2") bg-gray-800 @endif flex-col items-center transition duration-300 rounded-lg justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
            <svg
            ...
            <span
                class="text-sm text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500 text-nowrap">Tech Transfer</span>
        </button>
