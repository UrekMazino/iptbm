    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="col-span-2">
            <x-card class="shadow-lg  ">
                <x-header-label class="mb-10">
                    Update Agency Details
                </x-header-label>
                <div class="space-y-4">
                    <div class=" p-2 border border-gray-400 dark:border-gray-600 rounded-lg">
                        <div class="justify-end flex">
                            <x-pop-modal class="max-w-lg" modal-title="Update agency Name" name="updateName" static="true">
                                <form class="space-y-5" wire:submit.prevent="saveAgencyName">
                                    <div>
                                        <x-input-label for="agnem" value="Agency name"/>
                                        <x-text-input wire:model.lazy="agencyName" class="w-full" id="agnem" type="text" placeholder="Enter text here"/>
                                        <x-input-error :messages="$errors->get('agencyName')" />
                                    </div>
                                    <x-submit-button wire:loading wire:target="saveAgencyName">
                                        Processing...
                                    </x-submit-button>
                                    <x-submit-button wire:loading.remove wire:target="saveAgencyName">
                                        Submit
                                    </x-submit-button>
                                </form>
                            </x-pop-modal>
                    ...
                    <div class=" p-2 border border-gray-400 dark:border-gray-600 rounded-lg">
                        <div class="justify-end flex">
                            <x-pop-modal class="max-w-lg" modal-title="Update agency Address" name="updateAddress" static="true">
                                <form class="space-y-5" wire:submit.prevent="saveAgencyAddress">
                                    <div>
                                        <x-input-label for="agAd" value="Agency address"/>
                                        <x-text-input wire:model.lazy="agencyAddress" class="w-full" id="agAd" type="text" placeholder="Enter text here"/>
                                        <x-input-error :messages="$errors->get('agencyName')" />
                                    </div>
                            ...
                            <x-secondary-button data-modal-toggle="updateAddress" class="text-sky-600 dark:text-sky-600">
                                Update
                            </x-secondary-button>
                        </div>
                        <div class="divide-y divide-gray-400 dark:divide-gray-600 p-3">
                    ...
                    <div class=" p-2 border border-gray-400 dark:border-gray-600 rounded-lg">
                        ...
                        <div class="mt-2">
                            <div class="space-y-4 w-full md:w-1/2 mt-3">
                                <div>
                                    <div class="flex justify-start items-center">
                                        <x-pop-modal class="max-w-lg" name="agencyaddEmail" static="true" modal-title="Update Email">
                                            <form class="space-y-4" wire:submit.prevent="saveAgencyEmail">
                                                <div>
                                                    <x-input-label value="Email" />
                                                    <x-text-input wire:model.lazy="agencyContactEmail" class="w-full" type="email" placeholder="sample@mail.com"/>
                                        ...
                                        <button class="me-4" data-modal-toggle="agencyaddEmail">
                                    ...
                                    <div class="ms-5 mt-1">
                                        <ul class="divide-y divide-gray-400 dark:divide-gray-600">
                                            @foreach($agency->contacts->where('contact_type', 'email') as $contact)
                                                <li class="p-2 transition duration-300 hover:bg-gray-200 dark:hover:bg-gray-800">
                                                   <div class="flex justify-between items-center">
                                                       <div>
                                                           {{$contact->contact}}
                                                       </div>
                                                       <x-pop-modal class="max-w-md text-center" name="deleteAgencyContact-{{$contact->id}}">
                                                           ...
                                                           <div class="flex justify-center items-center space-x-4">
                                                               ...
                                                               <button wire:click.prevent="deleteAgencyContact({{$contact->id}})" type="submit" class="py-2 px-3 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">
                                                                   Yes, I'm sure
                                                               </button>
                                                           </div>
                                                       </x-pop-modal>
                                                       <button data-modal-toggle="deleteAgencyContact-{{$contact->id}}" >
                                ...
                                <div>
                                    <div class="flex justify-start items-center">
                                        <x-pop-modal class="max-w-lg" name="agencyaddPhoneN" static="true" modal-title="Update Phone">
                                            <form class="space-y-4" wire:submit.prevent="saveAgencyPhone">
                                                <div>
                                                    <x-input-label value="Phone" />
                                                    <x-text-input wire:model.lazy="agencyContactPhone" class="w-full" type="number" placeholder="area code + 7 digits"/>
                                        ...
                                        <button class="me-4" data-modal-toggle="agencyaddPhoneN">
                                            <svg class="w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                                                <path d="M12.687 14.408a3.01 3.01 0 0 1-1.533.821l-3.566.713a3 3 0 0 1-3.53-3.53l.713-3.566a3.01 3.01 0 0 1 .821-1.533L10.905 2H2.167A2.169 2.169 0 0 0 0 4.167v11.666A2.169 2.169 0 0 0 2.167 18h11.666A2.169 2.169 0 0 0 16 15.833V11.1l-3.313 3.308Zm5.53-9.065.546-.546a2.518 2.518 0 0 0 0-3.56 2.576 2.576 0 0 0-3.559 0l-.547.547 3.56 3.56Z"/>
                                                <path d="M13.243 3.2 7.359 9.081a.5.5 0 0 0-.136.256L6.51 12.9a.5.5 0 0 0 .59.59l3.566-.713a.5.5 0 0 0 .255-.136L16.8 6.757 13.243 3.2Z"/>
                                            </svg>
                                    ...
                                    <div class="ms-5 mt-1">
                                        <ul class="divide-y divide-gray-400 dark:divide-gray-600">
                                            @foreach($agency->contacts->where('contact_type', 'phone') as $contact)
                                                <li class="p-2 transition duration-300 hover:bg-gray-200 dark:hover:bg-gray-800">
                                                    <div class="flex justify-between items-center">
                                                        <div>
                                                            {{$contact->contact}}
                                ...
                                <div>
                                    <div class="flex justify-start items-center">
                                        <x-pop-modal class="max-w-lg" name="agencyaddMobile" static="true" modal-title="Update Email">
                                            <form class="space-y-4" wire:submit.prevent="saveAgencyMobile">
                                                <div>
                                                    <x-input-label value="Mobile"/>
                                                    <x-text-input wire:model.lazy="agencyContactMobile" class="w-full" type="number" placeholder="09xxxxxxxxx"/>
                                        ...
                                        <button class="me-4" data-modal-toggle="agencyaddMobile">
                                    ...
                                    <div class="ms-5 mt-1">
                                        <ul class="divide-y divide-gray-400 dark:divide-gray-600">
                                            @foreach($agency->contacts->where('contact_type', 'mobile') as $contact)
                                                <li class="p-2 transition duration-300 hover:bg-gray-200 dark:hover:bg-gray-800">
                                                    <div class="flex justify-between items-center">
                                                        <div>
                                                            {{$contact->contact}}
                                ...
                                <div>
                                    <div class="flex justify-start items-center">
                                        <x-pop-modal class="max-w-lg" name="agencyaddFax" static="true" modal-title="Update Fax">
                                            <form class="space-y-4" wire:submit.prevent="saveAgencyFax">
                                                <div>
                                                    <x-input-label value="Fax" />
                                                    <x-text-input wire:model.lazy="agencyContactFax" class="w-full" type="number" placeholder="area code + 7 digit"/>
                                        ...
                                        <button class="me-4" data-modal-toggle="agencyaddFax">
                                            <svg class="w-4 h-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                                                <path d="M12.687 14.408a3.01 3.01 0 0 1-1.533.821l-3.566.713a3 3 0 0 1-3.53-3.53l.713-3.566a3.01 3.01 0 0 1 .821-1.533L10.905 2H2.167A2.169 2.169 0 0 0 0 4.167v11.666A2.169 2.169 0 0 0 2.167 18h11.666A2.169 2.169 0 0 0 16 15.833V11.1l-3.313 3.308Zm5.53-9.065.546-.546a2.518 2.518 0 0 0 0-3.56 2.576 2.576 0 0 0-3.559 0l-.547.547 3.56 3.56Z"/>
                                                <path d="M13.243 3.2 7.359 9.081a.5.5 0 0 0-.136.256L6.51 12.9a.5.5 0 0 0 .59.59l3.566-.713a.5.5 0 0 0 .255-.136L16.8 6.757 13.243 3.2Z"/>
                                            </svg>
                                    ...
                                    <div class="ms-5 mt-1">
                                        <ul class="divide-y divide-gray-400 dark:divide-gray-600">
                                            @foreach($agency->contacts->where('contact_type', 'fax') as $contact)
                                                <li class="p-2 transition duration-300 hover:bg-gray-200 dark:hover:bg-gray-800">
                                                    <div class="flex justify-between items-center">
                                                        <div>
                                                            {{$contact->contact}}
        ...
        <div class="space-y-4">
                            ...
                            @forelse($agency->profiles->users as $user)
                                <li class="py-3 sm:pb-4">
                                    <div class="flex items-center ">
                                        <a href="{{route("iptbm.admin.addrecord.editaccount",['id'=>$user->id])}}" class="hover:underline hover:text-sky-500">
            ...
            <x-card class="shadow-lg space-y-4">
                <div class=" p-2 border border-gray-400 dark:border-gray-600 rounded-lg">
                    <div >
                        <div class="justify-end flex">
                            <x-pop-modal class="max-w-lg" modal-title="Update agency Head" name="updatHead" static="true">
                                <form class="space-y-5" wire:submit.prevent="saveAgencyHead">
                                    <div>
                                        <x-input-label for="agAd" value="Agency Head"/>
                                        <x-text-input wire:model.lazy="agencyHead" class="w-full" id="agAd" type="text" placeholder="Enter text here"/>
                ...
                <div class=" p-2 border border-gray-400 dark:border-gray-600 rounded-lg">
                    <div >
                        <div class="justify-end flex">
                            <x-pop-modal class="max-w-lg" modal-title="Update Designation" name="updatedDes" static="true">
                                <form class="space-y-5" wire:submit.prevent="saveDesignation">
                                    <div>
                                        <x-input-label for="agAd" value="Designation"/>
                                        <x-text-input wire:model.lazy="designation" class="w-full" id="agAd" type="text" placeholder="Enter text here"/>
                ...
                <div class=" p-2 border border-gray-400 dark:border-gray-600 rounded-lg">
                    ...
                    <div class="space-y-4 w-full md:w-3/4 mt-3">
                            ...
                            <div class="flex justify-start items-center">
                                <x-pop-modal class="max-w-lg" name="addEmail" static="true" modal-title="Update Email">
                                    <form class="space-y-4" wire:submit.prevent="saveContactEmail">
                                        <div>
                                            <x-input-label value="Email" />
                                            <x-text-input wire:model.lazy="email" class="w-full" type="email" placeholder="sample@mail.com"/>
                            ...
                            <div class="flex justify-start items-center">
                                <x-pop-modal class="max-w-lg" name="addPhone" static="true" modal-title="Update Phone">
                                    <form class="space-y-4" wire:submit.prevent="saveContactPhone">
                                        <div>
                                            <x-input-label value="Phone" />
                                            <x-text-input wire:model.lazy="phone" class="w-full" type="tel" placeholder="area code + 7 digit"/>
                            ...
                            <div class="flex justify-start items-center">
                                <x-pop-modal class="max-w-lg" name="addFax" static="true" modal-title="Update Fax">
                                    <form class="space-y-4" wire:submit.prevent="saveContactFax">
                                        <div>
                                            <x-input-label value="Fax" />
                                            <x-text-input wire:model.lazy="fax" class="w-full" type="number" placeholder="area code + 7 digit"/>
                        ...
                        <div>
                            <div class="flex justify-start items-center">
                                <x-pop-modal class="max-w-lg" name="addMobile" static="true" modal-title="Update Mobile">
                                    <form class="space-y-4" wire:submit.prevent="saveContactMobile">
                                        <div>
                                            <x-input-label value="Mobile" />
                                            <x-text-input wire:model.lazy="mobile" class="w-full" type="number" placeholder="09*********"/>
