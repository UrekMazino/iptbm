<div class="mx-4">
    ...
    <x-card class="shadow-lg">
        ...
        <div class="space-y-5">
            <x-card class="max-w-3xl border border-gray-200 dark:border-gray-600 m-auto dark:bg-gray-800">
                <div class="mb-3">
            ...
            <x-card-panel title="Account Status" class="max-w-3xl border border-gray-200 dark:border-gray-600 m-auto dark:bg-gray-800">
                <x-slot:button>
                    <livewire:iptbm.admin.account.account-status wire:key="user-account-{{$user->id}}" :user="$user" />
                </x-slot:button>
                @if($user->trashed())
                    <div class="font-medium text-2xl text-red-600">
                        Disabled
                    </div>
                @else
                    <div class="font-medium text-2xl text-green-600">
                        Active
                    </div>
                @endif
            </x-card-panel>
