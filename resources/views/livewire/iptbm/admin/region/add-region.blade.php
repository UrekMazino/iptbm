        ...
        <form class="space-y-10" wire:submit.prevent="saveForm">
           <div class="space-y-3">
               ...
               <div>
                   ...
                   <x-text-input wire:model.lazy="region_rrdcc_chair" class="w-full" id="rrdc" placeholder="enter text here" />
                   <x-input-error :messages="$errors->get('region_rrdcc_chair')" />
               </div>
               <div>
                   <x-input-label for="consor" value="Consortium" />
                   <x-text-input wire:model.lazy="region_consortium" class="w-full" id="consor" placeholder="enter text here" />
                   <x-input-error :messages="$errors->get('region_consortium')" />
               </div>
               <div>
                   <x-input-label for="consDir" value="Consortium Director" />
                   <x-text-input wire:model.lazy="region_consortium_director" class="w-full" id="consDir" placeholder="enter text here" />
