            ...
            <x-card class="shadow-lg mb-4">
                ...
                <div class="justify-start items-center block md:flex">
                    <div class="border rounded-lg border-gray-400 dark:border-gray-600 p-2">
                        <div class="aspect-square bg-gradient-to-tr mx-5 from-gray-900 to-gray-100 w-52 h-52 rounded-full border-gray-400 dark:border-gray-200  overflow-hidden border-8">
                            <svg class="w-60 h-60 text-gray-200 dark:text-gray-200" viewBox="0 0 96 96" fill="currentColor" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="Icons_Welder" overflow="hidden">
                                ...
                                <path d="M76.8 59.6C73.1566 56.9892 69.1902 54.8615 65 53.27L65 66C66.6569 66 68 67.3431 68 69L68 82 80 82 80 66C79.9478 63.4946 78.773 61.1451 76.8 59.6Z"/>
                                <path d="M28 82 28 69C28 67.3431 29.3431 66 31 66L31 53.22C27.2585 54.513 23.7198 56.3312 20.49 58.62 20.4954 58.7133 20.4954 58.8067 20.49 58.9L20.49 70.8C22.665 72.3428 23.9698 74.8336 24 77.5 23.9956 79.1035 23.5153 80.6697 22.62 82Z"/>
                        ...
                        <div class="border rounded border-gray-400 dark:border-gray-600 px-4 py-2 mt-2 relative">
                            ...
                            <x-pop-modal close-action="resetStatusModel" static="true" class="max-w-md" name="inventor-status-update" modal-title="Update Status">
                            ...
                            <button data-modal-toggle="inventor-status-update" class="absolute top-0 right-0">
                                <svg class="w-5 h-5 text-sky-600 dark:text-sky-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                    ...
                    <div class="p-0 md:px-4">
                        ...
                        <div class="divide-y-2 divide-gray-400 dark:divide-gray-600">
                             <div class="text-gray-700 text-xl dark:text-gray-200 justify-between flex items-center">
                                 ...
                                 <div class="py-2">
                                     <x-pop-modal name="updateInventorName" modal-title="Update Full name" static="true" class="max-w-md">
                                         <form class="mt-4" wire:submit.prevent="updateFullName">
                                             <x-input-label class="my-2">
                                                 <div>
                                                     First Name
                                                 </div>
                                                 <x-text-input wire:model.lazy="fname" class="w-full"  placeholder="first name"/>
                                                 @error('fname')
                                                 <x-input-error :messages="$message"/>
                                                 @enderror
                                             </x-input-label>
                                             <x-input-label class="my-2">
                                                 ...
                                                 <x-text-input wire:model.lazy="mname" class="w-full"  placeholder="middle name"/>
                                                 @error('mname')
                                                 <x-input-error :messages="$message"/>
                                                 @enderror
                                             </x-input-label>
                                             <x-input-label class="my-2">
                                                 ...
                                                 <x-text-input wire:model.lazy="lname" class="w-full" placeholder="last name"/>
                                                 @error('lname')
                                                 <x-input-error :messages="$message"/>
                                                 @enderror
                                             </x-input-label>
                                             <x-input-label class="my-2">
                                                 ...
                                                 <x-text-input wire:model.lazy="sname" class="w-1/2" placeholder="last name"/>
                                                 @error('sname')
                                                 <x-input-error :messages="$message"/>
                                                 @enderror
                                             </x-input-label>
                                     ...
                                     <x-secondary-button data-modal-toggle="updateInventorName" class="text-sky-600 dark:text-sky-600">
                        ...
                        <div class="divide-y-2 divide-gray-400 dark:divide-gray-600">
                            <div class="text-gray-700 text-xl dark:text-gray-200 justify-between flex items-center">
                                ...
                                <div class="py-2">
                                    <x-pop-modal close-action="resetAddress" static="true" class="max-w-xl space-y-2" modal-title="Update Inventor Address" name="updateInventorAddress">
                                       <form wire:submit.prevent="updateAddress">
                                           <div class="mt-4">
                                               ...
                                               <x-submit-button wire:loading wire:target="updateAddress" class="mt-3" type="submit">
                                                   Processing...
                                               </x-submit-button>
                                               <x-submit-button wire:loading.remove wire:target="updateAddress" class="mt-3" type="submit">
                                                   Submit
                                               </x-submit-button>
                                           </div>
                                       </form>
                                    </x-pop-modal>
                                    <x-secondary-button data-modal-toggle="updateInventorAddress" class="text-sky-600 dark:text-sky-600">
                                        <svg class="w-4 h-4 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                                            <path d="M12.687 14.408a3.01 3.01 0 0 1-1.533.821l-3.566.713a3 3 0 0 1-3.53-3.53l.713-3.566a3.01 3.01 0 0 1 .821-1.533L10.905 2H2.167A2.169 2.169 0 0 0 0 4.167v11.666A2.169 2.169 0 0 0 2.167 18h11.666A2.169 2.169 0 0 0 16 15.833V11.1l-3.313 3.308Zm5.53-9.065.546-.546a2.518 2.518 0 0 0 0-3.56 2.576 2.576 0 0 0-3.559 0l-.547.547 3.56 3.56Z"/>
                                            <path d="M13.243 3.2 7.359 9.081a.5.5 0 0 0-.136.256L6.51 12.9a.5.5 0 0 0 .59.59l3.566-.713a.5.5 0 0 0 .255-.136L16.8 6.757 13.243 3.2Z"/>
                                        </svg>
                ...
                <div class="p-2 mt-4">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <x-pop-modal name="addExpertiseMod" modal-title="Update Field of Expertise" static="true" class="max-w-md">
                            <form wire:submit.prevent="addExpertise" wire:ignore.self>
                                <div class="mb-6 mt-4">
                                    <label for="expert" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Field </label>
                                    <input wire:model="expertise" type="text" id="expert" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter text here..." required>
                            ...
                            @foreach($inventor->expertise as $key=>$expertise)
                                <li class="p-2 flex justify-between items-center hover:bg-gray-300 dark:hover:bg-gray-800 dark:hover:bg-opacity-25 rounded-lg transition duration-300">
                                    ...
                                    <div class="text-base text-gray-600 dark:text-gray-400 flex">
                                        <svg class="w-6 h-6 text-gray-800 dark:text-white me-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
                                    ...
                                    <div>
                                        <livewire:iptbm.staff.inventor.delete-experties-popup :id="$inventor->id" wire:key="{{$key}}" :expertise="$expertise"/>
                                    </div>
                                </li>
                            @endforeach
                        </ul>
