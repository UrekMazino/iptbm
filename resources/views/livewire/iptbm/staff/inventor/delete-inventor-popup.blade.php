<div>
    ...
    <div id="popup-modal{{$inventor->id}}" tabindex="-1"
        ...
        <div class="relative w-full max-w-md max-h-full">
            <div class="relative bg-gray-50 rounded-lg shadow dark:bg-gray-700">
                <button type="button"
                        ...
                        data-modal-hide="popup-modal{{$inventor->id}}">
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to
                        delete this "{{$inventor->name}}"?</h3>
                    <button wire:click="deleteRecord({{$inventor->id}})" type="button"
                            class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                        Yes, I'm sure
                    </button>
                    <button data-modal-hide="popup-modal{{$inventor->id}}" type="button"
