                    ...
                    <div class="rounded-lg p-2 bg-gray-300 dark:bg-gray-800">
                        ...
                        <div class="mt-3">
                            <form wire:submit.prevent="saveCompAddress">
                                <div class="mb-6">
                                    <input wire:model.lazy="compAddress" type="text" id="compName"
                                           class="bg-gray-50 border-l border-r border-t border-b border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                           placeholder="enter text here" required>
                    ...
                    <div class="rounded-lg p-2 bg-gray-300 dark:bg-gray-800">
                        ...
                        <div class="mt-3">
                            <form wire:submit.prevent="saveBusinessStructure">
                                <div class="mb-6">
                                    <select wire:model="businessStructure" id="countries"
                                            class="bg-gray-50 border-l border-r border-t border-b border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <div class="rounded-lg p-2 bg-gray-300 dark:bg-gray-800">
                        ...
                        <div class="mt-3">
                            <form wire:submit.prevent="saveBusinessRegistration">
                                <div class="mb-6">
                                    <select wire:model="businessRegistration" id="countries"
                                            class="bg-gray-50 border-l border-r border-t border-b border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option value="" disabled selected>
                                    ...
                                    <div wire:loading wire:target="businessRegistration"
                    ...
                    <div class="rounded-lg p-2 bg-gray-300 dark:bg-gray-800">
                        ...
                        <div class="mt-3">
                            <form wire:submit.prevent="saveTechAcquisition">
                                <div class="mb-6">
                                    <select wire:model="techAcquisition" id="countries"
                                            class="bg-gray-50 border-l border-r border-t border-b border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option value="" disabled selected>
