<div class="py-4 px-2 group hover:bg-gray-200 dark:hover:bg-gray-900 rounded transition duration-200">
   ...
   {{-------
    <div class="mt-4">
        <button data-modal-target="authentication-marketFile-{{$file->id}}-{{$univId}}"
                data-modal-toggle="authentication-marketFile-{{$file->id}}-{{$univId}}"
                class="rounded-full group-hover:text-sky-600 hover:bg-gray-400 hover:dark:bg-gray-950 group-hover:dark:text-sky-600 group-hover:border-sky-600 group-hover:dark:border-sky-600 transition duration-200 border border-gray-200 dark:border-gray-700 px-4 py-1">
            View Attachment
        </button>
        <button data-modal-target="popup-deletePreconFile-{{$file->id}}-{{$univId}}"
                data-modal-toggle="popup-deletePreconFile-{{$file->id}}-{{$univId}}"
                class="rounded-full hover:bg-red-300 hover:dark:bg-red-950 group-hover:text-red-600 group-hover:dark:text-red-600 group-hover:border-red-600 group-hover:dark:border-red-600 transition duration-200 border border-gray-200 dark:border-gray-700 px-4 py-1">
            Delete
        </button>
