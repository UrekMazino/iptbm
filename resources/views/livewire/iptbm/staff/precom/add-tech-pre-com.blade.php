<div wire:ignore.self id="addPrecomBot" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
     class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-w-md max-h-full">
        <!-- Modal content -->
        <div class="relative bg-gray-50 rounded-lg shadow dark:bg-gray-700">
            <button data-modal-hide="addPrecomBot" id="addPrecomBot" type="button"
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" wire:submit.prevent="savePrecomTech">
                    <div class="mb-4">
                        ...
                        <input wire:model.lazy="techModel" list="techList" type="search" id="techModel"
                    ...
                    <div class="mb-4">
                        <label for="techNewName" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Additional
                            Technology name (Optional)</label>
                        <textarea wire:model.lazy="techNewName" id="techNewName" rows="4"
