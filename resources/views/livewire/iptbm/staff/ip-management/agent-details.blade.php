<div class="w-full p-2 ">
    <div class="flex justify-between">
        ...
        <button data-tooltip-target="tooltip-animation{{$agent->id}}" data-modal-toggle="deleteModal{{$agent->id}}"
                class="text-red-600 hover:text-red-700 transition duration-300" type="button">
            <span class="fa-solid fa-trash-can "></span>
        </button>
        <div id="tooltip-animation{{$agent->id}}" role="tooltip"
             class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-gray-50 transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-600">
            Delete Agent?
        ...
        <!-- Main modal -->
        <div id="deleteModal{{$agent->id}}" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                ...
                <div class="relative p-4 text-center bg-gray-50 rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    <button type="button"
                            ...
                            data-modal-toggle="deleteModal{{$agent->id}}">
                    ...
                    <div class="flex justify-center items-center space-x-4">
                        ...
                        <button data-modal-toggle="deleteModal" wire:click="deleteAgent" type="submit"
                    ...
                    <form wire:submit.prevent="savePhone">
                        <div class="mb-6">
                            ...
                            <input wire:model.lazy="phoneModel" type="number" id="phone"
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                   placeholder="(xxx)/(xx) xxx xxxx" required>
                            @error('phoneModel')
                            <div id="alert-border-2"
                                 class="flex items-center p-4 mb-4 text-red-800 border-t border-b border-l border-r border-red-300 bg-red-50 dark:text-red-400 dark:bg-gray-800 dark:border-red-800 rounded-lg mt-2"
                                 role="alert">
