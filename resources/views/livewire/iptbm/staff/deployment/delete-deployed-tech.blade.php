<div>
    ...
    <!-- Main modal -->
    <div wire:ignore.self id="deleteModal{{$technology->id}}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            ...
            <div class="relative p-4 text-center bg-gray-50 rounded-lg shadow dark:bg-gray-800 sm:p-5">
                <button type="button"
                        ...
                        data-modal-toggle="deleteModal{{$technology->id}}">
                ...
                <div class="flex justify-center items-center space-x-4">
                    <button data-modal-toggle="deleteModal{{$technology->id}}" type="button"
                    ...
                    <button wire:click.prevent="deleteItem" type="submit"
                            class="py-2 px-3 text-sm font-medium text-center text-gray-50 bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">
                        Yes, I'm sure
                    </button>
                </div>
            </div>
