<div wire:ignore.self id="addDeployedTech" tabindex="-1" aria-hidden="true"
     class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-w-md max-h-full">
        <!-- Modal content -->
        <div class="relative bg-gray-50 rounded-lg shadow dark:bg-gray-700">
            <button wire:click.prevent="resetVal" type="button" id="closeAddRec"
                    class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                    data-modal-hide="addDeployedTech">
            ...
            <div class="px-6 py-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Technologies for Deployment</h3>
                <form class="space-y-6" wire:submit.prevent="saveForm">
                    <div>
                        ...
                        <input wire:ignore.self wire:model.lazy="technology" autocomplete="off" type="search"
                               list="techList" id="searchTech"
                    ...
                    <div class="mb-6">
                        <label for="adoptorName" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name
                            of Adopter</label>
                        <input wire:ignore.self wire:model.lazy="adopter" type="text" id="adoptorName"
                    ...
                    <div class="mb-6">
                        ...
                        <input wire:ignore.self wire:model.lazy="address" type="text" id="adoptorName"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
