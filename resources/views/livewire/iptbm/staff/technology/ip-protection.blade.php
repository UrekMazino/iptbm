        ...
        <x-pop-modal static="true" class="max-w-xl " name="applicationModal" modal-title="IP Protection Application">
            <form class="mt-3" wire:submit.prevent="saveForm">
                ...
                <x-input-label class="mt-4">
                    Application number
                    <x-text-input wire:model.lazy="applicationNumberModel" placeholder="enter text here"
                                  class="w-full"/>
                ...
                <x-input-label class="mt-4">
                    ...
                    <div class="relative w-full ">
                        ...
                        <x-text-input wire:model="dateFiledModel" id="dateFiled" readonly class="pl-10 p-2.5 w-full"
        ...
        <ul class="space-y-2 indent-0  mt-5">
            @foreach($technology->ip_applications as $protection)
                <li>
                    ...
                    <a href="{{route("iptbm.staff.ip-management.application.index",['id'=>$protection->id])}}"
                       class="inline-flex shadow-lg items-center justify-center p-2 text-base font-medium text-gray-500 rounded-lg bg-gray-50 hover:text-gray-900 hover:bg-gray-300 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-600 dark:hover:text-white">
                        <span class="w-full">
    ...
    <script type="text/javascript">
        document.addEventListener('livewire:load', function () {
            ...
            document.getElementById('dateFiled').addEventListener('changeDate', (event) => {
                ...
                @this.
                dateFiledModel = event.target.value;
