    ...
    <div class="mt-4">
        <dl class="w-full text-gray-900  space-y-4 py-2  dark:text-gray-50 ">
            @forelse($technologyInventors as $generator)
                <div>
                    <div
                        class="border border-gray-200 dark:border-gray-700 rounded flex justify-between hover:bg-gray-500 dark:hover:bg-gray-950 hover:bg-opacity-25 px-2 transition duration-300">
