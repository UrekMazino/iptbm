<x-pop-modal name="{{$modalName}}" class="max-w-md  overflow-y-scroll" static="true" modal-title="Extension Pathway">
    <form class="space-y-3" wire:submit.prevent="saveForm">
        ...
        <div class="flex justify-start space-x-4">
            ...
            <x-submit-button wire:click.prevent="resetForm" type="reset" class="mt-4 bg-gray-700 dark:bg-gray-200 text-gray-white dark:text-gray-800 font-medium">
                Reset Fields
            </x-submit-button>
        </div>
