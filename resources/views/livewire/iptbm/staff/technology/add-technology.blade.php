<div class="mx-4 px-4">
    ...
    <form wire:submit.prevent="submit">
        <div
            class="w-full   mt-4 mb-3 rounded-lg p-4 shadow-lg border-l relative border-r border-t border-b border-gray-200 bg-white  shadow-black shadow-md dark:bg-gray-800 dark:border-gray-600">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="justify-center items-center ">
                    <div class="m-auto w-full mb-4">
                        ...
                        <textarea wire:model="title" id="title" rows="5"
                ...
                <div>
                    <div class="justify-center items-center">
                        <div
                            class="m-auto  aspect-square max-w-lg border-l border-r border-t border-b border-opacity-50 rounded-lg p-4 shadow-lg">
                            <label wire:loading.class="blur" wire:target="photo" for="dropzone-file"
                                ...
                                <input wire:model="photo" id="dropzone-file" type="file" accept="image/jpeg,image/png"
                                       class="hidden"/>
                            </label>
                            @error('photo')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <div class="mb-6">
                        <label for="datepicker" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Year
                            Developed</label>
                        <input
                            type="number"
                            min="1900"
                    ...
                    <div class="mb-6">
                        <label for="agency" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Tech
                            Owner ( agencies )</label>
                        <select wire:model="techAgency" id="agency"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div>
                    <div class="mb-6">
                        <label for="industry" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Tech
                            Industry</label>
                        <select wire:model="techIndustry" id="industry"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <div class="mb-6">
                        <label for="techStatus" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Tech
                            Status ( <span class="text-sm">Readiness</span> )</label>
                        <select wire:model="techStatus" id="techStatus"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <div wire:loading wire:target="submit"
                 class="absolute left-0 top-0 w-full h-full flex justify-items-center items-center bg-gray-300 dark:bg-gray-400 bg-opacity-50 dark:bg-opacity-50">
