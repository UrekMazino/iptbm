    ...
    <div>
        ...
        <div class="border border-gray-400 dark:border-gray-600 rounded p-2 gap-2 flex justify-between items-center">
            ...
            <div>
                ...
                <x-secondary-button data-modal-target="editHead" data-modal-toggle="editHead">
                    Edit
                </x-secondary-button>
            </div>
        </div>
    ...
    <div class="space-y-4 pt-5">
        ...
        <div class="border border-gray-400 dark:border-gray-600 rounded p-2 gap-2 ">
            <div class="flex justify-between items-center">
                ...
                <x-secondary-button data-modal-toggle="addMobile" data-modal-target="addMobile">
                    Add Mobile
                </x-secondary-button>
            </div>
            <ul class="mt-5">
        ...
        <div class="border border-gray-400 dark:border-gray-600 rounded p-2 gap-2 ">
            <div class="flex justify-between items-center">
                ...
                <x-secondary-button data-modal-toggle="addPhone" data-modal-target="addPhone">
                    Add Mobile
                </x-secondary-button>
            </div>
            <ul class="mt-5">
