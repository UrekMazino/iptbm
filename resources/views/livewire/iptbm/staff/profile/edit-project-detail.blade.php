...
<div class="my-3 mx-lg-5 px-4 mb-10">
                ...
                @foreach($project->projectDetails as $key=>$budget)
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap border border-gray-200 dark:border-gray-700">
                            @if($key!=0)
                                @if($projectState)
                                    <livewire:iptbm.staff.profile.delete-project-year :project="$project" wire:key="delete-{{$key}}"
                                                                                      :projectYear="$budget" />
    ...
    <div class="w-full flex justify-end mb-3 rounded-lg border bg-white dark:bg-gray-700 p-4 shadow-lg border-gray-200 dark:border-gray-600">



        <div wire:ignore.self id="popup-modal-{{$project->id}}" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <button wire:click.prevent="deleteProject" data-modal-hide="popup-modal" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                            Yes, I'm sure
                        </button>
        ...
        <div >
            <x-danger-button  data-modal-target="popup-modal-{{$project->id}}" data-modal-toggle="popup-modal-{{$project->id}}" class="justify-center items-center">
                <svg class="w-6 me-3 h-6 text-red-300 dark:text-red-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
