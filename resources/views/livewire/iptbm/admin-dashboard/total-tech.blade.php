<div class="rounded-none md:rounded-lg bg-gradient-to-tr from-emerald-700 to-emerald-300 ">
    <x-pop-modal name="crypto-modal-techno" class="max-w-5xl " modal-title="Total IP-TBMs Technologies">
        <x-card-panel>
            <div class="relative overflow-x-auto ">
                <table id="techAllTable" style="width:100%"
                    ...
                    <tr class="border-0 ">
                        <th scope="col"
                            class="w-fit flex-nowrap whitespace-nowrap col-span-4 px-10 py-3 border border-gray-300 dark:border-gray-600 text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            Agency
                        </th>


                        <th scope="col"
                            class="w-full col-span-8 px-6 py-3 border border-gray-300 dark:border-gray-600 text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            Title
                        </th>
                    </tr>
                    ...
                    @foreach($technologies as $technology)
                        <tr>
                            ...
                            <td >
                                <a href="{{route("iptbm.admin.technology.view-tech",['technology'=>$technology])}}"
