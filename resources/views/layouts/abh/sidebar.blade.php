...
>
    <div class="overflow-y-auto py-5 pb-10 px-3 h-full bg-white dark:bg-gray-800">
        ...
        <ul class="space-y-2  text-gray-600 dark:text-gray-400">
            ...
            <li>
                <a  class="flex items-center   p-2 rounded-lg transition duration-300 @if(Request::segment(2)=='dashboard') bg-gray-300 dark:bg-gray-950 text-sky-700 @endif hover:bg-gray-200  dark:hover:bg-gray-700 group" href="{{route("iptbm.staff.dashboard")}}">

                    <svg fill="currentColor" class="h-4 w-4 me-2  @if(Request::segment(2)=='dashboard') bg-gray-300 dark:bg-gray-950 text-sky-700 @endif" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 448 512">
            ...
            <li >
                <div class="divide-y divide-slate-200">
                    <!-- Accordion item -->
                    <div x-data="{ expanded: @if(Request::segment(2)!='profile') false @else true @endif  }" class="py-2">
                        <h2>
                            <button
            ...
            <li>
                <a  class="flex items-center  p-2 rounded-lg transition duration-300
                     @if(Request::segment(2)=='inventor') bg-gray-300 dark:bg-gray-950 text-sky-700 @endif hover:bg-gray-200  dark:hover:bg-gray-700 group"  href="{{route("iptbm.staff.inventor")}}">
            ...
            <li >
                <div class="divide-y divide-slate-200">
                    <!-- Accordion item -->
                    <div x-data="{ expanded: @if(Request::segment(2)!='technology') false @else true @endif  }" class="py-2">
                        <h2>
                            <button
                                id="faqs-title-profile"
                                type="button"
                        ...
                        >
                            <div class="overflow-hidden">
                                <ul id="dropdown-example" class="py-2 space-y-2 text-sm text-gray-600 dark:text-gray-400 ">

                                    <li>
                                        <a href="{{route("iptbm.staff.technology")}}" class="flex items-center w-full p-2  transition duration-75 rounded-lg pl-11 group  dark:hover:bg-gray-600 hover:bg-gray-200  @if(Route::currentRouteName()=="iptbm.staff.technology") bg-gray-300 dark:bg-gray-950 text-sky-700 @endif">My Technologies</a>
                                    </li>
                                    <li>
                                        <a href="{{route("iptbm.staff.technology.all")}}" class="flex items-center w-full p-2  transition duration-75 rounded-lg pl-11 group hover:bg-gray-200  dark:hover:bg-gray-600 @if(Route::currentRouteName()=="iptbm.staff.technology.all") bg-gray-300 dark:bg-gray-950 text-sky-700 @endif">All Technologies</a>
                                    </li>
            ...
            <li >
                <a  class="flex items-center gap-2 p-2 rounded-lg transition duration-300
                    @if(Request::segment(2)=='ip-management') bg-gray-300 dark:bg-gray-950 text-sky-700 @endif hover:bg-gray-200  dark:hover:bg-gray-700 group"  href="{{route("iptbm.staff.ip-management")}}">

                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="currentColor" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M224 0c-17.7 0-32 14.3-32 32V51.2C119 66 64 130.6 64 208v18.8c0 47-17.3 92.4-48.5 127.6l-7.4 8.3c-8.4 9.4-10.4 22.9-5.3 34.4S19.4 416 32 416H416c12.6 0 24-7.4 29.2-18.9s3.1-25-5.3-34.4l-7.4-8.3C401.3 319.2 384 273.9 384 226.8V208c0-77.4-55-142-128-156.8V32c0-17.7-14.3-32-32-32zm45.3 493.3c12-12 18.7-28.3 18.7-45.3H224 160c0 17 6.7 33.3 18.7 45.3s28.3 18.7 45.3 18.7s33.3-6.7 45.3-18.7z"/></svg>
                    IP Alert
                </a>
            ...
            <li >
                <div class="divide-y divide-slate-200">
                    <!-- Accordion item -->
                    <div x-data="{ expanded: @if(!(Request::segment(2)=="pre-commercialization" ||Request::segment(2)=="adopter")) false @else true @endif   }" class="py-2">
                        <h2>
                            <button
                                id="faqs-title-profile"
                                type="button"
                        ...
                        >
                            <div class="overflow-hidden">
                                <ul id="dropdown-example" class="ms-4 py-2 space-y-2 text-sm text-gray-900 dark:text-gray-400 ">
                                    ...
                                    <li>
                                        ...
                                        <a
                                            ...
                                            <div class=" @if(Request::segment(2)=="pre-commercialization") text-blue-600 @endif">
