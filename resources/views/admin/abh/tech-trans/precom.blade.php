        ...
        <div class="px-4 w-full mt-10">
            ...
            <x-card>
                <div class="relative overflow-x-auto ">
                    <table id="precomTab" style="width:100%" class="w-fit display cell-border stripe table-auto  hover text-sm  rounded text-left text-gray-500  border-gray-300 dark:border-gray-600  dark:text-gray-400">
                        ...
                        <tr class="border-0 ">
                            ...
                            <th scope="col" class=" newTechTitle px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                New Tech Title
                            </th>
                            ...
                            <th scope="col" class=" startCap px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                Starting Capital
                            </th>
                            <th scope="col" class=" startCap px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                Acquisition Cost
                            </th>
                            <th scope="col" class=" income px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                Income Generated
                            </th>
                            <th scope="col" class=" investment px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                Return of Investment
                            </th>
                            <th scope="col" class=" comeMode px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            ...
                            <th scope="col" class=" w-fit action px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                Actions
                            </th>
                        </tr>
                        ...
                        @foreach($precoms as $precom )
                            <tr>
                                ...
                                <td>
                                    <x-link-button :url="route('iptbm.admin.techtrans.precom.view',['precom'=>$precom])" value="Open"/>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
