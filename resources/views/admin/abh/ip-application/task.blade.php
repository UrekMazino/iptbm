        ...
        <div class="px-0 md:px-4 w-full mt-10">
            <x-card class="px-0 py-0 pb-0 pt-0 rounded-none md:rounded-lg shadow-lg">
                <div class="grid grid-cols-1 relative overflow-hidden  py-24">
                    ...
                    <div class="absolute top-0 left-0 w-full h-full bg-black  bg-opacity-75 rounded-none md:rounded-lg"></div>
                    <div class="z-10 p-4">
                ...
                <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
                    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist">
                        <li class="mr-2" role="presentation">
                            <button class="inline-block p-4 border-b-2 rounded-t-lg" id="profile-tab" data-tabs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Task</button>
                        </li>
                        <li class="mr-2" role="presentation">
                            <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="dashboard-tab" data-tabs-target="#dashboard" type="button" role="tab" aria-controls="dashboard" aria-selected="false">Abstract</button>
                        </li>
                        <li class="mr-2" role="presentation">
                            <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="settings-tab" data-tabs-target="#settings" type="button" role="tab" aria-controls="settings" aria-selected="false">Expenses</button>
                        </li>
                        <li role="presentation">
                            <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="contacts-tab" data-tabs-target="#contacts" type="button" role="tab" aria-controls="contacts" aria-selected="false">Status</button>
                        </li>
                    </ul>
                </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <ol class="relative text-gray-500 border-l border-gray-400 dark:border-gray-700 dark:text-gray-400">
                                    @foreach($stages as $key=>$collection)
                                        <li class="mb-10 ml-6">
                                        <span class="absolute flex items-center justify-center w-6 h-6 bg-gray-400 rounded-full -left-3 ring-4 ring-gray-200 dark:ring-gray-900 dark:bg-gray-950">
                                                ...
                                                @foreach($collection as $tasks)
                                                    <li>
                                                        <p class="text-sm">
                                                            ...
                                                            <a href="{{route("iptbm.admin.ip-application-report.task-details",['task'=>$tasks->id])}}" class="inline-flex items-center justify-center p-2 text-sm font-medium text-gray-500 rounded-lg bg-gray-50 hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
                                                                <svg class="w-3 h-3 me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 8 14">
                                                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 13 5.7-5.326a.909.909 0 0 0 0-1.348L1 1"/>
                                                                </svg>

                                                                <span class="w-full">{{$tasks->stage->stage_name}}</span>
                            ...
                            <ul class="mt-2 divide-y divide-gray-400 dark:divide-gray-600">
                                ...
                                <li>
                                    <x-input-label class="py-2 text-xl">
                                        Total Expenses : <span class="fa-solid fa-peso-sign mx-2"></span>{{number_format($task->expenses->sum('amount'),2)}}
                                    </x-input-label>
                                </li>
                            </ul>
                        </x-card>
