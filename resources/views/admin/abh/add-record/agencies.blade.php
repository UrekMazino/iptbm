        ...
        <div class="px-4 w-full mt-5">
           ...
           <x-card class="shadow-lg">
               <div class="relative overflow-x-auto ">
                   <table id="agencyTable" class="w-fit display cell-border stripe table-auto md:table-fixed hover text-sm  rounded text-left text-gray-500  border-gray-300 dark:border-gray-600  dark:text-gray-400">
                       ...
                       <tr>
                           ...
                           <th scope="col" class="account px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                               Users Account
                           </th>
                                   ...
                                   @if($agency->profiles)
                                       <ul class="list-inside">
                                           @foreach($agency->profiles->users as $user)
                                               ...
                                               <li>
                                                   <a href="{{route("iptbm.admin.addrecord.editaccount",['id'=>$user->id])}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                                       {{$user->name}}
                                                   </a>
