        ...
        <div class="px-4 w-full mt-10">
            ...
            <x-card>
                <div class="relative overflow-x-auto ">
                    <table id="extensionTable" style="width:100%"
                        ...
                        @foreach($extensions as $extension)
                            <tr>
                                <td>
                                    <a href="{{route("iptbm.admin.technology.view-tech",['technology'=>$extension->technology])}}"
                                ...
                                <td>
                                    <a href="{{route("iptbm.admin.view-agency",['agency'=>$extension->technology->iptbmprofiles->agency])}}"
                                       class="font-medium text-sky-600 dark:text-sky-500 hover:underline">
