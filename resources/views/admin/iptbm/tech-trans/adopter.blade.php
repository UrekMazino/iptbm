                ...
                <div class="relative overflow-x-auto ">
                    <table id="precomTab" style="width:100%"
                        ...
                        <tr class="border-0 ">
                            ...
                            <th scope="col"
                                class=" compDesc px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                Company Description
                            </th>
                            <th scope="col"
                                class=" busiStruct px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                Business Structure
                            </th>
                            <th scope="col"
                                class=" busiReg px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                Business Registration
                            </th>
                            <th scope="col"
                                class=" acquis px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                Acquisition Mode
                            </th>
                            <th scope="col"
                                class=" incub px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                For Incubation
                            </th>
                        ...
                        @foreach($adopters as $adopter )
                            <tr>
                                ...
                                <td>
                                    <x-link-button
                                        :url="route('iptbm.admin.techtrans.adopter.view',['adopter'=>$adopter])"
                                        value="Open"/>
                                </td>
                            </tr>
                        @endforeach
