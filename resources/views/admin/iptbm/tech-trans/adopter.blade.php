                ...
                <div class="relative overflow-x-auto ">
                    <table id="precomTab" style="width:100%" class="w-fit display cell-border stripe table-auto md:table-fixed hover text-sm  rounded text-left text-gray-500  border-gray-300 dark:border-gray-600  dark:text-gray-400">
                        ...
                        <tr class="border-0 ">
                            ...
                            <th scope="col" class=" compDesc px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                Company Description
                            </th>
                            <th scope="col" class=" busiStruct px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                Business Structure
                            </th>
                            <th scope="col" class=" busiReg px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                Business Registration
                            </th>
                            <th scope="col" class=" acquis px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                Acquisition Mode
                            </th>
                            <th scope="col" class=" incub px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                For Incubation
                            </th>
                        ...
                        @foreach($adopters as $adopter )
                            <tr>
                                ...
                                <td>
                                    {{\Carbon\Carbon::parse($adopter->date_created)->format('F-d-Y')}}                                </td>
                                <td>
                                    {{\Carbon\Carbon::parse($adopter->date_updated)->format('F-d-Y')}}
                                </td>
                                <td>
                                    <x-link-button :url="route('iptbm.admin.techtrans.adopter.view',['adopter'=>$adopter])" value="Open"/>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
