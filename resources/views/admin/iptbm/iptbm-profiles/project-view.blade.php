                    ...
                    <div class="mt-4">
                        <ul class="divide-y divide-gray-400 dark:divide-gray-600">
                            @foreach($project->projectDetails as $key=>$detail)
                                <li>
                                    <livewire:iptbm.admin.project.project-year-details year-label="Year {{$key+1}}" :year-details="$detail"/>
                                </li>
                            @endforeach
                            <li>
                                <div class="mt-4">
                                    <div class="flex bg-white dark:bg-gray-950 border rounded border-gray-400 py-2 dark:border-gray-600 justify-center me-0 ms-auto items-center w-fit text-xl px-10 text-gray-800 dark:text-white">
                                        Total Budget :
