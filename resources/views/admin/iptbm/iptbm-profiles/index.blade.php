            ...
            <div
                ...
                <table id="profiletable"
                    ...
                    <tr class="border-0">
                        ...
                        <th scope="col"
                            class=" technology px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            Technologies
                        </th>
                        <th scope="col"
                    ...
                    <tr class="border-0 filters">
                        ...
                        <th scope="col"
                            class="fil contact px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">

                        </th>
                        <th scope="col"
                            class="fil  projects px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">

                        </th>
                        <th scope="col"
                            class="fil  technology px-6 py-3 border border-gray-300 dark:border-gray-600 text-base text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                        ...
                                        @foreach($profile->projects as $project)
                                            <li class="py-2">
                                                ...
                                                <div class="mt-2">
                                                    ...
                                                    <div>
                                                        <span
                                                            class="fa-solid fa-peso-sign"></span> {{number_format($project->projectDetails->sum('year_budget'),2)}}
                                                    </div>
                                                </div>
                                            </li>
                                        @endforeach
