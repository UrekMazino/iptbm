...
@section('content')
    <div class="w-full pb-10">
        ...
        <div
            class="my-4 border bg-white dark:bg-gray-800 border-blue-700 border-opacity-20 dark:border-gray-500 dark:border-opacity-20 w-1/2 mx-auto p-4 rounded-lg">
