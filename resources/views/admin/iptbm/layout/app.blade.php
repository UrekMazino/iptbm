...
<head>
    ...
    <link href="https://cdn.datatables.net/v/ju/jszip-3.10.1/dt-1.13.6/b-2.4.2/b-colvis-2.4.2/b-html5-2.4.2/b-print-2.4.2/cr-1.7.0/date-1.5.1/fc-4.3.0/fh-3.4.0/rg-1.4.0/sc-2.2.0/sp-2.2.0/sl-1.7.0/sr-1.3.0/datatables.min.css" rel="stylesheet">

    <script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/pdfmake.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/vfs_fonts.js"></script>
    <script src="https://cdn.datatables.net/v/ju/jszip-3.10.1/dt-1.13.6/b-2.4.2/b-colvis-2.4.2/b-html5-2.4.2/b-print-2.4.2/cr-1.7.0/date-1.5.1/fc-4.3.0/fh-3.4.0/rg-1.4.0/sc-2.2.0/sp-2.2.0/sl-1.7.0/sr-1.3.0/datatables.min.js"></script>
                ...
                <div class="flex justify-start items-center">
                    ...
                    <a href="{{\App\Providers\RouteServiceProvider::IPTBM_ADMIN_DASHBOARD}}"
                       class="flex items-center justify-between mr-4">
                        ...
                        <span
                            class="self-center text-2xl font-bold gradient-text whitespace-nowrap ">IP-TBM MS</span>
                    </a>
                        ...
                        >
                            <li>
                                <a
                                    ...
                                    <form id="logout-form" action="{{ route('admin.iptbm.logout') }}" method="POST"
                                          class="d-none">
                                        @csrf
                                    </form>
                                    Sign out</a>
